...
(function () {
  ...
  /* ---------------- 共享样式（仅注入一次） ---------------- */
  var SHARED_CSS = [
    '.gl-modal-overlay{position:fixed;inset:0;z-index:200;background:rgba(0,0,0,.45);display:flex;align-items:flex-start;justify-content:center;padding:8vh 16px 32px;overflow-y:auto;}',
    '.gl-modal{background:var(--brand-card);border:1px solid var(--brand-border);border-radius:var(--r-lg,8px);box-shadow:var(--shadow-3,0 24px 60px -20px rgba(0,0,0,.2));width:100%;max-width:560px;animation:gl-pop .18s ease-out;}',
    ...
    '.gl-modal-close{width:28px;height:28px;display:flex;align-items:center;justify-content:center;border:none;background:none;border-radius:var(--r-sm,4px);color:var(--ink-3,#86868b);cursor:pointer;}',
    ...
    '.gl-field-label{display:block;font-size:12px;font-weight:500;color:var(--ink-2,#6e6e73);margin-bottom:5px;}',
    '.gl-input,.gl-select,.gl-textarea{width:100%;box-sizing:border-box;padding:7px 10px;border:1px solid var(--brand-input,#d2d2d7);border-radius:var(--r-md,4px);font-size:13px;font-family:var(--font-sans);color:var(--brand-foreground);background:var(--brand-surface,#fff);outline:none;}',
    ...
    '.gl-toast{display:flex;align-items:flex-start;gap:8px;padding:10px 14px;border-radius:var(--r-md,4px);background:var(--brand-surface,#fff);border:1px solid var(--brand-border);box-shadow:var(--shadow-2,0 8px 24px -8px rgba(0,0,0,.12));font-size:13px;color:var(--brand-foreground);animation:gl-in .18s ease-out;}',
    ...
    '.gl-dropdown{position:absolute;top:calc(100% + 8px);right:0;z-index:150;width:300px;background:var(--brand-popover,#fff);border:1px solid var(--brand-border);border-radius:var(--r-md,4px);box-shadow:var(--shadow-2,0 8px 24px -8px rgba(0,0,0,.12));overflow:hidden;display:none;}',
    ...
    '.gl-dropdown-item-time{font-size:11px;color:var(--ink-3,#86868b);margin-top:2px;font-family:var(--font-mono);font-variant-numeric:tabular-nums;}',
    '.gl-empty{padding:28px 16px;text-align:center;color:var(--ink-3,#86868b);font-size:13px;}',
    '.chip{display:inline-flex;align-items:center;gap:4px;padding:4px 12px;border-radius:999px;font-size:12px;font-weight:500;cursor:pointer;border:1px solid var(--brand-border);color:var(--ink-2,#6e6e73);background:var(--brand-surface,#fff);white-space:nowrap;}',
    ...
    '.gl-kv td:first-child{width:120px;color:var(--ink-2,#6e6e73);font-size:12px;}',
    ...
    '.gl-contact-card{display:inline-flex;align-items:center;gap:20px;padding:14px 22px;border:1px solid var(--brand-border);border-radius:var(--r-lg,8px);background:var(--brand-surface,#fff);text-align:left;box-shadow:var(--shadow-1,0 1px 3px rgba(0,0,0,.06));}',
    ...
    '.gl-qr-modal-cap{margin-top:10px;font-size:12px;color:var(--ink-2,#6e6e73);}',
